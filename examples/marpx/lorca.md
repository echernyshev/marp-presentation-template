---
title: Marp Example - Lorca
author: Ernesto Serrano
description: Canonical use of Lorca Theme features
keywords: [Marp, MarpX, Lorca, Ernesto Serrano]
...
![bg left:33%](./assets/images/thinkers/lorca01.jpg)

<div class="title"> Federico García Lorca: The Voice and the Duende </div>
<div class="subtitle"> Between poetry, music, and tragedy </div> 
<div class="author"> Federico García Lorca (1898–1936) </div>
<div class="date"> Granada, Spain </div>
<div class="organization"> Residencia de Estudiantes, Madrid </div>

---

<!-- _class: title -->
![bg opacity:0.5 grayscale:1](./assets/images/places/alhambra-granada-spain.jpg)
<!-- _backgroundColor: rgba(238, 238, 238, 0.91)  -->

# Federico García **Lorca**: The Voice and the Duende
## Between poetry, music, and tragedy
...
[![bg left:50%](https://upload.wikimedia.org/wikipedia/commons/9/99/LorcaSundial.jpg)]()
